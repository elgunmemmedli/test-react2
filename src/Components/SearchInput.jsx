    ...
    return (
        <>
            <form className="flex max-w-md">
                <div className="flex ">
                    <div className="relative w-full mr-[30px] mt-1">
                        <input type="search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[300px] h-[35px] p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for city or address" required />
